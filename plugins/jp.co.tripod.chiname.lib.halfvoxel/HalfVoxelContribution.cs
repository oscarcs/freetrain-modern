...
namespace freetrain.world.structs.hv
{
	...
	public class HalfVoxelContribution : StructureContribution
	{
		...
		{			
			_price = long.Parse( XmlUtil.selectSingleNode(e,"price").InnerText );			
		...
		protected readonly long _price;
		public override long price {	get { return _price; } }
		...
		public Structure create( Location baseLoc, Direction front, PlaceSide side ) 
		{
            ...
            if(v==null){
                AccountGenre.SUBSIDIARIES.spend( price );
	...
	internal class EmptyReference: ContributionReference
	{
		...
		public override long price{get{ return 0; }}
