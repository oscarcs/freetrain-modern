...
// 2009.05.08 Yz 該当するコントリビューションが存在しない場合にカラーインデックスを変更すると例外が発生するバグを修正
using System;
...
namespace freetrain.world.road.dummycar
{
	...
	public class ControllerForm : ControllerHostForm {
		...
		public ControllerForm() {
            ...
            if (((Array)typeBox.DataSource).Length == 0) {                      // 該当コントリビューションがない場合
                this.typeBox.Enabled = false;
                this.preview.Enabled = false;
                this.colSelector.Enabled = false;
