...
namespace freetrain.contributions.train
{
	...
	public abstract class TrainContribution : Contribution
	{
		...
		/// <summary> Amenity ratio of this train. </summary>
		public abstract int amenity { get; }

		/// <summary> Trip range of this train's passengers. </summary>
		public abstract int triprange { get; }
		...
		public string triprangeDisplayName {
			get {
				switch(triprange) {
				case 0:	return "短距離";
				case 1:	return "中距離";
