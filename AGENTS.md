...
Try to make the port as faithful to the original as possible in functionality - the new code can be cleaner, more performant, or use modern code patterns and language features, but the behaviour should match the original.
