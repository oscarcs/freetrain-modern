...
namespace freetrain.world
{
	...
	public class Time
	{
        ...
        ///<summary>start time of Game</summary>
        public long gameStartTime { get { return START_TIME; } }
        ...
        public bool isHoliday {
            get{
              ...
              if( month == 12 )
                if( day==23 ) return true;
                if( day==30 || day==31 ) return true;

//              Time yesterday = (Time)currentTime - DAY;
//              if( yesterday.isHoliday && dayOfWeek==1 && month!=1 && day!=4 ) return true;
