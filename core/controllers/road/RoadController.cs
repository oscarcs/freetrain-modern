...
//			RoadPattern.getStraight(d).drawAlpha( canvas.surface, pt );
		...
		protected override void InitializeComponent()
		{
            ...
            this.costBox1.Location = new System.Drawing.Point(12, 128);
			...
			this.contribTree.Size = new System.Drawing.Size(128, 130);
		...
		{
			string text = new string[]{"未定義","小道","街路","高速道","線路敷石"}[(int)style.Type];
