// 2008.11.12 YZ Modify splash screen
// 2008.11.12 YZ Modify draw logo point & draw timing
using System;
...
//			if(progress>0.4 && exflag){
			if(progress>0 && exflag){
#endregion
				Graphics g = pictureBox1.CreateGraphics();
#region YZ_20081112_MODIFIED
//				imageList.Draw(g,232,128,0);
				imageList.Draw(g,174,128,0);
#endregion
				exflag = false;
			}
		}
        ...
        this.status.Size = new System.Drawing.Size(324,30);
        ...
        this.imageList.Images.SetKeyName(0,"exav.gif");
        // 
        // progressBar
        // 
        this.progressBar.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
        this.progressBar.Location = new System.Drawing.Point(1,245);
        this.progressBar.Name = "progressBar";
        this.progressBar.Size = new System.Drawing.Size(322,9);
