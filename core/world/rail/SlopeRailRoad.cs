// 2010.05.09 riorio Add RailRoadCost *2 under ground
using System;
...
//		public object GetRealObject(StreamingContext sc) { return theInstance; }
	...
	public class SlopeRailRoad : RailRoad
	{
		...
		private const int SLOPE_CONSTRUCTION_UNIT_COST = 40000000;	// taken from A4.*1000
		private const int SLOPE_DESTRUCTION_UNIT_COST  =  8000000;
		...
		public static int calcCostOfNewSlope( Location _base, Direction dir ) {
			...
			int height = _base.z - World.world.waterLevel;
            int multiplier = ( height < 0 )? height * -2 : height + 1;
			return SLOPE_CONSTRUCTION_UNIT_COST * multiplier;
		}
		...
		public static int calcCostOfTearDownSlope( Location loc, Direction dir ) {
			...
			return SLOPE_DESTRUCTION_UNIT_COST*(Math.Abs(loc.z-World.world.waterLevel)+1);
		}
